...
This script will plot factor maps for portfolio S
'''
###################################################################### 
...
DVPredictors = ['D_TT', 'D_Cont']
DUPredictors2 = ['Inflow_scale', 'Trans_cost']
...
plotCombinedFactorMaps(ax, result, 'Durham', 'Demand Growth Scaling Factor', 'Transfer Trigger',
	 [0, .5, 1], ['0.5', '1.0', '2.0'], [0, .2, .4, .6, .8, 1], \
	 ['0', '0.02', '0.04', '0.06', '0.08', '0.10'], [],[], DUPredictors2, DU_base, levels)

#plt.show()
plt.savefig('../Factor_maps/Solution'+solution_num+'/Durham_all.svg', bbox_inches='tight')
...
plotCombinedFactorMaps(ax, result, 'Raleigh', 'Demand Growth Scaling Factor', 'Contingency Fund Contribution',
	 [0, .5, 1], ['0.5', '1.0', '2.0'], [0, .25, .5, .75, 1], \
	 ['0.8', '0.9', '1.0', '1.1', '1.2'], [],[], DUPredictors2, DU_base, levels)
plt.show()
#plt.savefig('../Factor_maps/Solution'+solution_num+'/Raleigh_all.png', bbox_inches='tight')
...
# maps are combined into a final figure in adobe illustrator
