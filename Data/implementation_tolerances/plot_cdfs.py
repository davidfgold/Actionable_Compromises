...
def plot_cdf(util, axis, obj, sol):
	# load the data
	name = util +'_' + obj + '_' + sol + '.csv'
	og_name = util +'_' + obj + '_original_' + sol + '.csv'
...
# save the figure (right now this makes a svg, change to .png for easier viewing)
plt.savefig('Figures/All_cdfs.svg', bbox_inches='tight', format='svg')
